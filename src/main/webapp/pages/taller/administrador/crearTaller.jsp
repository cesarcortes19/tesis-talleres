...
<div id="formulario" class="formulario">
    ...
    <div id="formularioInterno" class="formInterno">
        <s:form action="guardarCrearTaller" namespace="/administrador/taller" id="formCrearTaller" enctype="multipart/form-data" acceptcharset="UTF-8">
            <s:textfield key="taller.form.label.nombre" name="tallerModel.name" cssClass="box requerido" maxlength="250"/>
            <s:textarea key="taller.form.label.descripcion" name="tallerModel.descripcion" cssClass="boxArea requerido" maxlength="250"/>
            <s:textfield key="taller.form.label.cantidad.inscripciones" name="tallerModel.cantidadAlumnosMaxima" onkeypress="return onlyNumber(event);" cssClass="box requerido" maxlength="250"/>
            ...
            <s:textfield id="mensualidadInput" key="taller.form.label.horario.mensualidad" name="tallerModel.costo" cssClass="box requerido" onkeypress="return onlyNumberColonAndDot(event);" value="0" maxlength="250"/>
            <s:textfield id="inscripcionInput" key="taller.form.label.horario.inscripcion" name="tallerModel.costoInscripcion" cssClass="box requerido" onkeypress="return onlyNumberColonAndDot(event);" value="0" maxlength="250"/>
        ...
        <div id="your-picture-bg"><img id="imgSalida" width="200px" height="200px" src=""/><br><br>
            <span style="font-size: 11px">*Si no sube una imagen, se mostrara el logo del colegio como imagen predeterminada
