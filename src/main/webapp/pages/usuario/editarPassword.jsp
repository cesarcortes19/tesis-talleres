    ...
    <div id="titulo" class="TituloformInterno">
        ...
        <div id="formularioInterno" class="formInternoCrearNoticia">
            <s:form action="passwordEditarUsuario" namespace="/usuario" id="editarPasswordUsuario">
                <s:textfield id="newPass" key="usuario.form.label.newpassword" name="usuarioModel.password" cssClass="box" maxlength="10"/>
                <s:textfield id="newPassRepeat" key="usuario.form.label.confirmarpassword" name="usuarioModel.confirmPassword" cssClass="box" maxlength="10"/>
