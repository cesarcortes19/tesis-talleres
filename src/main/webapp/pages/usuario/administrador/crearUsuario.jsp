        ...
        <div id="formularioInterno" class="formInterno">
            <s:form action="guardarCrearUsuario" namespace="/administrador/usuario" id="formCrearUsuario"
                ...
                <s:textfield key="usuario.form.label.nombre" name="usuarioModel.nombre"
                             onkeypress="return onlyLetters(event);" cssClass="box requerido" maxlength="20"/>
                ...
                <s:textfield key="usuario.form.label.cedula" name="usuarioModel.cedula"
                             onkeypress="return onlyNumber(event);" cssClass="box requerido" maxlength="20"/>
                <s:password key="usuario.form.label.password" name="usuarioModel.password" cssClass="box requerido"
                            maxlength="10"/>
                <s:textfield key="usuario.form.label.email1" name="usuarioModel.email" cssClass="box requerido" maxlength="20"/>
                <s:textfield key="usuario.form.label.email2" name="usuarioModel.email2" cssClass="box" maxlength="20"/>
                ...
                <s:textfield key="usuario.form.label.telefono2" name="usuarioModel.telefono2"
                             onkeypress="return onlyNumber(event);" cssClass="box" maxlength="20"/>
                <s:textarea key="usuario.form.label.direccion" name="usuarioModel.direccion" cssClass="boxArea requerido"
                            maxlength="250"/>
