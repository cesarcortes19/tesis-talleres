    ...
    <div id="titulo" class="TituloformInterno">
        ...
        <div id="formularioInterno" class="formInternoCrearNoticia">
            <s:form action="guardarEditarPasswordAdmin" namespace="/administrador/usuario" id="editarPasswordadministrador">
                <s:textfield id="newPass" key="usuario.form.label.newpassword" name="usuarioModel.password" cssClass="box" maxlength="20"/>
                <s:textfield id="newPassRepeat" key="usuario.form.label.confirmarpassword" name="usuarioModel.confirmPassword" cssClass="box" maxlength="20"/>
